...
class CraftiumEnv(Env):
    ...
    :param mt_channel_timeout: Number of seconds to wait for MT to connect to the TCP channel. If the timeout is reached a Timeout exception is raised. **WARNING:** When using multiple (serial) MT environments, timeout can be easily reached for the last environment. In this case, you might want to increase the value of this parameter according to the number of environments.
    """
    ...
    def __init__(
        ...
        self.mt_chann = MtChannel(
            ...
            port=self.mt.port,
            connect_timeout=mt_channel_timeout,
        )
