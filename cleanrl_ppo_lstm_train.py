# This script is an adaptation of the CleanRL's `ppo_atari_lstm.py` to work with Craftium environments.
#
# Original source can be found at https://github.com/vwxyzjn/cleanrl/blob/master/cleanrl/ppo_atari_lstm.py
# Docs can be found at https://docs.cleanrl.dev/rl-algorithms/ppo/#ppo_atari_lstmpy
import os
import random
import time
...
class Args:
    ...
    wandb_project_name: str = "craftium-ppo-lstm"
    ...
    env_id: str = "Craftium/OpenWorld-v0"
...
if __name__ == "__main__":
    ...
    envs = vector_env(
        [make_env(args.env_id, i, args.capture_video, run_name, args.mt_port+i,
                  args.mt_wd, args.frameskip, args.seed) for i in range(args.num_envs)],
    )
            ...
            if "final_info" in infos:
                for info in infos["final_info"]:
                    if info and "episode" in info:
                        ...
                        writer.add_scalar(
                            "charts/episodic_length", info["episode"]["l"]*args.frameskip, global_step)
